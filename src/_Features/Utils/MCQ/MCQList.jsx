...
// Props:
// - mcqData: { items: [], page, per_page, total }
// - loading, error
...
const MCQList = ({
  ...
  if (isServerPaginated) {
    // Server handled filtering/pagination — display items as-is and compute pages from server total
    paginatedMCQs = mcqData.items ?? [];
