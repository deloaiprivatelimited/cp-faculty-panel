...
// - rearrangeData: { items: [], page, per_page, total }
// - loading, error
...
const RearrangeList = ({
  ...
  if (isServerPaginated) {
    ...
    paginated = clientFiltered.slice(startIndex, startIndex + itemsPerPage);
    totalItemsToShow = totalFiltered;
  }

  // Preview handlers
  const handlePreview = (rearrange) => {
      ...
      + Add
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-4">
            <div className="lg:col-span-2">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search rearrange questions..."
                  value={searchTerm}
          ...
          <div className="flex items-center justify-between">
            <p className="text-sm text-[#555555]">
              Showing {showingCount} of {totalDisplayText} rearrange questions
            </p>
            <button
